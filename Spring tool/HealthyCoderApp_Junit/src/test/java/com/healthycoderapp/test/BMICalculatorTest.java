...
class BMICalculatorTest {
	...
	private String environment="dev";  //prod
	
	 @Nested
	 @DisplayName("{{}} same inner class Display name")
	class IsDietRecommendedTests{
		 
		 @Test
		 @DisplayName(">>>sample method name")
	 ...
	 @Nested
		class FindCoderWithWorstBMI{
		 ...
		 @Test
			...
			@Test
			void should_ReturnCoderWithWorstBMIInMs_When_coderListHas10000Elements2() {
				
				// given
				assumeTrue(BMICalculatorTest.this.environment.equals("prod"));  // when enviroment is different it will Skip
				List<Coder> coders=new ArrayList<>();
